...
public interface DemandeDao extends JpaRepository<Libre_demande, Long> {
	...
	@Query(value="select id_libre_demande,\r\n"
			...
			+ "	  and l.mat_pers = p.mat_pers \r\n"
			+ "   and l.cod_soc =:codSoc\r\n"
			+ " and (get_pere_by_pere(l.cod_soc,p.cod_serv,:codServ)=:codServ or l.mat_pers=:matpers)\r\n" 
			+ "and :matpers in(select mat_pers from service where cod_serv=:codServ)\r\n" ,nativeQuery = true)
	public List<Libre_demande> getDemm(@Param("codSoc")String codSoc,@Param("matpers") String matpers
		,@Param("codServ") String codServ);
	...
	@Query(value="select id_libre_demande,\r\n"
			...
			+ "   and l.cod_soc =:codSoc\r\n"
			+ " and (get_pere_by_pere(l.cod_soc,p.cod_serv,:codServ)=:codServ or l.mat_pers=:matpers)\r\n" 
			+ "and :matpers in(select mat_pers from service where cod_serv=:codServ) and l.reponse_chef is  null "
	...
	@Query(value="select id_libre_demande,\r\n"
			...
			+ "   and l.cod_soc =:codSoc\r\n"
			+ " and (get_pere_by_pere(l.cod_soc,p.cod_serv,:codServ)=:codServ or l.mat_pers=:matpers)\r\n" 
			+ "and :matpers in(select mat_pers from service where cod_serv=:codServ) and l.reponse_chef in ('O','N') and l.typ_demande not in('P','S','D')\r\n" ,nativeQuery = true)
	...
	@Query(value="select id_libre_demande,\r\n"
			...
			+ " where l.cod_soc = p.cod_soc \r\n"
			+ "	  and l.mat_pers = p.mat_pers \r\n"
			+ "and( l.reponse_chef in ('O') or l.reponse_chef is null)"
