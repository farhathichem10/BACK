...
//	
	...
	@Query(value="select  cod_soc,\r\n"
			...
			+ "    id_personnel\r\n"
			+ "From personnel p\r\n"
			+ "where  (get_pere_by_pere(p.cod_soc,p.cod_serv,:cod)=:cod or p.mat_pers=:matpers)\r\n"
			+ "and :matpers in(select mat_pers from service where cod_serv=:cod) and p.etat_act in (0,1) \r\n ",nativeQuery = true)
	public List <Personnel> getPersonnel2(@Param("cod") String cod, @Param("matpers") String mat);
