...
public class AdrPers implements Serializable{
	...
	public AdrPers(CleAdrPers id, String cod_gouv, String cod_deleg, String cod_post, String libpost, String rue,
			String rue_a, String tel_pers, String fax_pers, String adr_courant, String adrelectronique,
			String tel_port_pers, Long numero_adr, String etat_adr, String immb_pers, String app_pers,
			String local_pers, String rec_mail, String cod_user, String lib_gouv) {
		super();
		this.id = id;
	...
	public AdrPers(CleAdrPers id, String cod_gouv, String cod_deleg, String cod_post, String libpost, String rue,
			String rue_a, String tel_pers, String fax_pers, String adr_courant, String adrelectronique,
			String tel_port_pers, Long numero_adr, String etat_adr, String immb_pers, String app_pers,
			String local_pers, String rec_mail, String cod_user) {
		super();
		this.id = id;
		this.cod_gouv = cod_gouv;
		this.cod_deleg = cod_deleg;
