...
public class JwtResponse {
	...
	private String role_portail;

	
	public JwtResponse(String token, String type, Long use_id, String usematricule, String uselogin, String use_pswd,
			...
			String use_updtby, String cod_soc, String matpers, String cod_site, String role_portail) {
		super();
		this.token = token;
		this.type = type;
		this.use_id = use_id;
